...
public interface QuestionMapper {
    ...
    @Select("select * from question where creator=#{userAccountId} limit #{size} offset #{offset}")
    List<Question> listByUserId(String userAccountId, Integer offset, Integer size);
